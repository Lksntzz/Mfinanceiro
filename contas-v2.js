...
function handleCardSubmit(event) {
  ...
  if (typeof window.FinanceStore.salvarCartao === "function") {
...
function handleLaunchSubmit(event) {
  ...
  if (typeof window.FinanceStore.salvarLancamentoCartao === "function") {
...
function handleDailyTableClick(event) {
  const button = event.target.closest("button[data-action]");
...
function handleInstallmentsTableClick(event) {
  const button = event.target.closest("button[data-action]");
